...
import 'package:flutter/cupertino.dart'
    hide CupertinoDatePickerMode, CupertinoDatePicker, CupertinoTimerPickerMode;
...
enum ZhCupertinoDatePickerMode {
...
///
/// There are several modes of the date picker listed in [ZhCupertinoDatePickerMode].
///
...
///  * [CupertinoPicker], the class that implements a content agnostic spinner UI.
class ZhCupertinoDatePicker extends StatefulWidget {
  /// Constructs an iOS style date picker.
  ///
  /// [mode] is one of the mode listed in [ZhCupertinoDatePickerMode] and defaults
  /// to [ZhCupertinoDatePickerMode.dateAndTime].
  ///
  /// [onDateTimeChanged] is the callback called when the selected date or time
  /// changes and must not be null. When in [ZhCupertinoDatePickerMode.time] mode,
  /// the year, month and day will be the same as [initialDateTime]. When in
  /// [ZhCupertinoDatePickerMode.date] mode, this callback will always report the
  ...
  /// Null if there's no limit. In [ZhCupertinoDatePickerMode.time] mode, if the
  ...
  /// [ZhCupertinoDatePickerMode.date] mode. Defaults to 1 and must not be null.
  ///
  /// [maximumYear] is the maximum year that the picker can be scrolled to in
  /// [ZhCupertinoDatePickerMode.date] mode. Null if there's no limit.
  ///
  /// [minuteInterval] is the granularity of the minute spinner. Must be a
  /// positive integer factor of 60.
  ///
  /// [use24hFormat] decides whether 24 hour format is used. Defaults to false.
  ZhCupertinoDatePicker({
    Key key,
    this.mode = ZhCupertinoDatePickerMode.dateAndTime,
    ...
    assert(
      mode != ZhCupertinoDatePickerMode.dateAndTime ||
          minimumDate == null ||
    ...
    assert(
      mode != ZhCupertinoDatePickerMode.date ||
  ...
  /// The mode of the date picker as one of [ZhCupertinoDatePickerMode].
  /// Defaults to [ZhCupertinoDatePickerMode.dateAndTime]. Cannot be null and
  /// value cannot change after initial build.
  final ZhCupertinoDatePickerMode mode;
  ...
  /// Minimum date that the picker can be scrolled to in [ZhCupertinoDatePickerMode.date]
  /// and [ZhCupertinoDatePickerMode.dateAndTime] mode. Null if there's no limit.
  final DateTime minimumDate;

  /// Maximum date that the picker can be scrolled to in [ZhCupertinoDatePickerMode.date]
  /// and [ZhCupertinoDatePickerMode.dateAndTime] mode. Null if there's no limit.
  ...
  State<StatefulWidget> createState() {
    ...
    // state.
    switch (mode) {
      case ZhCupertinoDatePickerMode.time:
      case ZhCupertinoDatePickerMode.dateAndTime:
        return _CupertinoDatePickerDateTimeState();
      case ZhCupertinoDatePickerMode.date:
      case ZhCupertinoDatePickerMode.year:
      case ZhCupertinoDatePickerMode.yearAndMonth:
      case ZhCupertinoDatePickerMode.month:
      case ZhCupertinoDatePickerMode.monthAndDay:
      case ZhCupertinoDatePickerMode.day:
        return _CupertinoDatePickerDateState(mode);
    }
...
class _CupertinoDatePickerDateTimeState extends State<ZhCupertinoDatePicker> {
  ...
  @override
  void didUpdateWidget(ZhCupertinoDatePicker oldWidget) {
  ...
  double _getEstimatedColumnWidth(_PickerColumnType columnType) {
    if (estimatedColumnWidths[columnType.index] == null) {
      estimatedColumnWidths[columnType.index] =
          ZhCupertinoDatePicker._getColumnWidth(
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.mode == ZhCupertinoDatePickerMode.dateAndTime) {
      if (localizations.datePickerDateTimeOrder ==
              DatePickerDateTimeOrder.time_dayPeriod_date ||
          localizations.datePickerDateTimeOrder ==
...
class _CupertinoDatePickerDateState extends State<ZhCupertinoDatePicker> {
  ZhCupertinoDatePickerMode showMode;

  _CupertinoDatePickerDateState(this.showMode);
    ...
    for (int i = 0; i < columnWidths.length; i++) {
      ...
      pickers.add(LayoutId(
        ...
        child: pickerBuilders[i](
          ...
          (BuildContext context, Widget child) {
            return Container(
              color: Color.fromARGB(77, 0, 255, 0),
              alignment: i == columnWidths.length - 1
                  ? alignCenterLeft
                  : alignCenterRight,
...
///  * [CupertinoTimerPicker], the class that implements the iOS-style timer picker.
///  * [CupertinoPicker], the class that implements a content agnostic spinner UI.
enum ZhCupertinoTimerPickerMode {
...
///    of the iOS-style date picker.
///  * [CupertinoPicker], the class that implements a content agnostic spinner UI.
class ZhCupertinoTimerPicker extends StatefulWidget {
  ...
  /// positive integer factor of 60.
  ZhCupertinoTimerPicker({
    Key key,
    this.mode = ZhCupertinoTimerPickerMode.hms,
  ...
  final ZhCupertinoTimerPickerMode mode;
...
class _CupertinoTimerPickerState extends State<ZhCupertinoTimerPicker> {
  ...
  void initState() {
    ...
    if (widget.mode != ZhCupertinoTimerPickerMode.ms)
      selectedHour = widget.initialTimerDuration.inHours;

    if (widget.mode != ZhCupertinoTimerPickerMode.hm)
  ...
  @override
  void didUpdateWidget(ZhCupertinoTimerPicker oldWidget) {
    super.didUpdateWidget(oldWidget);
  ...
  Widget _buildMinutePicker(EdgeInsetsDirectional additionalPadding) {
    ...
    switch (widget.mode) {
      case ZhCupertinoTimerPickerMode.hm:
        offAxisFraction = 0.5 * textDirectionFactor;
        break;
      case ZhCupertinoTimerPickerMode.hms:
        offAxisFraction = 0.0;
        break;
      case ZhCupertinoTimerPickerMode.ms:
        offAxisFraction = -0.5 * textDirectionFactor;
    }
