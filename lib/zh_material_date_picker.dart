...
/// monthly calendar initially in the dialog shown by calling [showZhDatePicker].
///
/// See also:
///
///  * [showZhDatePicker], which shows a dialog that contains a material design
///    date picker.
enum ZhDatePickerMode {
...
class _DatePickerHeader extends StatelessWidget {
  ...
  final ZhDatePickerMode mode;
  final ValueChanged<ZhDatePickerMode> onModeChanged;
  final Orientation orientation;

  void _handleChangeMode(ZhDatePickerMode value) {
  ...
  Widget build(BuildContext context) {
    ...
    switch (themeData.primaryColorBrightness) {
      case Brightness.light:
        dayColor =
            mode == ZhDatePickerMode.day ? Colors.black87 : Colors.black54;
        yearColor =
            mode == ZhDatePickerMode.year ? Colors.black87 : Colors.black54;
        break;
      case Brightness.dark:
        dayColor = mode == ZhDatePickerMode.day ? Colors.white : Colors.white70;
        yearColor =
            mode == ZhDatePickerMode.year ? Colors.white : Colors.white70;
        break;
    }
    ...
    final Widget yearButton = IgnorePointer(
      ignoring: mode != ZhDatePickerMode.day,
      ignoringSemantics: false,
      child: _DateHeaderButton(
        color: backgroundColor,
        onTap: Feedback.wrapForTap(
            () => _handleChangeMode(ZhDatePickerMode.year), context),
        child: Semantics(
          selected: mode == ZhDatePickerMode.year,
    ...
    final Widget dayButton = IgnorePointer(
      ...
      child: _DateHeaderButton(
        color: backgroundColor,
        onTap: Feedback.wrapForTap(
            () => _handleChangeMode(ZhDatePickerMode.day), context),
        child: Semantics(
          selected: mode == ZhDatePickerMode.day,
...
/// [showZhDatePicker], which creates a date picker dialog.
///
/// See also:
///
///  * [showZhDatePicker], which shows a dialog that contains a material design
...
///    time picker.
class ZhDayPicker extends StatelessWidget {
  /// Creates a day picker.
  ///
  /// Rarely used directly. Instead, typically used as part of a [ZhMonthPicker].
  ZhDayPicker({
    Key key,
    @required this.selectedDate,
  ...
  List<Widget> _getDayHeaders(
    ...
    for (int i = localizations.firstDayOfWeekIndex; true; i = (i + 1) % 7) {
      ...
      final String weekday = _narrowWeekdays[i];
...
///  * [showTimePicker], which shows a dialog that contains a material design
///    time picker.
class ZhMonthPicker extends StatefulWidget {
  ...
  @override
  _ZhMonthPickerState createState() => _ZhMonthPickerState();
}

class _ZhMonthPickerState extends State<ZhMonthPicker>
  ...
  @override
  void didUpdateWidget(ZhMonthPicker oldWidget) {
...
///  * [showTimePicker], which shows a dialog that contains a material design
///    time picker.
class ZhYearPicker extends StatefulWidget {
  ...
  @override
  _ZhYearPickerState createState() => _ZhYearPickerState();
}

class _ZhYearPickerState extends State<ZhYearPicker> {
...
class _DatePickerDialog extends StatefulWidget {
  ...
  final DateTime lastDate;
  final SelectableDayPredicate selectableDayPredicate;
  final ZhDatePickerMode initialDatePickerMode;
...
class _DatePickerDialogState extends State<_DatePickerDialog> {
  ...
  void _handleModeChanged(ZhDatePickerMode mode) {
    _vibrate();
    setState(() {
      _mode = mode;
      if (_mode == ZhDatePickerMode.day) {
        SemanticsService.announce(
  ...
  Widget _buildPicker() {
    assert(_mode != null);
    switch (_mode) {
      case ZhDatePickerMode.day:
        return ZhMonthPicker(
          key: _pickerKey,
...
///  * [showTimePicker], which shows a dialog that contains a material design
///    time picker.
///  * [ZhDayPicker], which displays the days of a given month and allows
///    choosing a day.
///  * [ZhMonthPicker], which displays a scrollable list of months to allow
///    picking a month.
///  * [ZhYearPicker], which displays a scrollable list of years to allow picking
///    a year.
Future<DateTime> showZhDatePicker({
  @required BuildContext context,
  @required DateTime initialDate,
  @required DateTime firstDate,
  @required DateTime lastDate,
  SelectableDayPredicate selectableDayPredicate,
  ZhDatePickerMode initialDatePickerMode = ZhDatePickerMode.day,
  Locale locale,
  TextDirection textDirection,
...
abstract class MonthWidget {
  Text monthText();
}

abstract class DayWidget {
  Text dayText();
}
